...
contract SequencerSetPublisher is Initializable, OwnableUpgradeable, ISequencerSetPublisher {
    ...
    function updateSequencerSet(uint256 goatHeight, SequencerSetUpdateWitness calldata witness) external override {
        ...
        emit SequencerSetUpdateSubmitted(goatHeight, pubkeyHash, witness.btcPubkey);
    }
